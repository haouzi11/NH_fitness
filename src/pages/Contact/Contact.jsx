      ...
      <div className="mx-4 my-10 md:my-20 md:flex ">
        <div className="md:w-2/3 md:mx-4 ">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="max-w-[600px]">
            ...
            <button
              type="submit"
              className="px-10 py-4 my-4 text-main text-lg hover:text-white hover:bg-main uppercase font-light"
              style={{ fontFamily: "'Teko', sans-serif", backgroundColor:'#38b6ff', color:'black', borderRadius:'12px' }}
            >
        ...
        <div className="my-4 md:w-1/3 md:mx-4">
          <div className="flex items-center">
            ...
            <div className="leading-none mx-4 my-8">
              <h3 className="text-xl">Casablanca , Hay Moulay Rachid</h3>
          ...
          <div className="flex items-center">
            ...
            <div className="leading-none mx-4 my-8">
              <h3 className="text-xl">+212 776564894</h3>
          ...
          <div className="flex items-center">
            ...
            <div className="leading-none mx-4 my-8">
              <h3 className="text-xl">ruizimrane1222@gmail.com</h3>
