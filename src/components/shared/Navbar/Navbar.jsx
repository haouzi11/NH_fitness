...
const Navbar = () => {
  ...
  return (
    <div className="bg-[#00000090] py-4 fixed top-0 z-50 w-full">
      {/* Mobile Menu */}
            ...
            {menus.map((menu, index) => {
              return (
                <Link
                  ...
                  key={index}
                  className="font-roboto font-medium block px-4 py-2 mt-2 text-sm text-black hover:text-black text-xl font-light transition duration-300"
                >
                  <li>{menu}</li>
                </Link>
              );
