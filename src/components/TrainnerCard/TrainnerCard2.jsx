...
const TrainnerCard2 = ({ name, title, image }) => {
  return (
    <div
      className="relative team overflow-hidden group transition duration-500 mx-auto my-10"
      style={{ backgroundImage: `url(${image})` }}
    >
      <img src={image} alt="" className="mx-auto" style={{width : '350PX', height : '450PX'}} />
      <div className="font-popins absolute text-white -bottom-20 group-hover:bottom-0 group-hover:bg-lightblue w-full py-10 px-5 transition duration-500  ">
        ...
        <div className="flex  space-x-4 my-4">
          <a href="https://www.facebook.com/profile.php?id=100067064070182" target="_blank" rel="noreferrer">
          ...
          <a href="https://www.instagram.com/kamal.ait.fit/" target="_blank" rel="noreferrer">
