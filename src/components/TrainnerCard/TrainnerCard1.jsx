...
const TrainnerCard1 = ({ name, title, image }) => {
  return (
    <div
    ...
    >
      ...
      <div className="font-popins absolute text-white -bottom-20 group-hover:bottom-0 group-hover:bg-lightblue w-full py-10 px-5 transition duration-500  ">
        ...
        <div className="flex  space-x-4 my-4">
          <a href="https://www.facebook.com/coach.fouadflex" target="_blank" rel="noreferrer">
          ...
          <a href="https://www.instagram.com/fouad.flex/" target="_blank" rel="noreferrer">
